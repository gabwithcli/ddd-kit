...
type EventData = z.infer<typeof RealEstateValuationAddedV1Schema>;

// 3. Create the event class.
export class RealEstateValuationAdded extends DomainEvent<EventData> {
  public static readonly type: RealEstateEventName =
    "RealEstateValuationAdded_V1";
  public readonly type: RealEstateEventName = RealEstateValuationAdded.type;

  constructor(data: EventData) {
    // 4. Validate the payload and call the base constructor.
    RealEstateValuationAddedV1Schema.parse(data);
    super(data);
  }
}
